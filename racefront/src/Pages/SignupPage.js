      ...
      <div style={{ paddingTop: '60px' }}>
        <div className="auth-container">
          ...
          <div className="auth-image-side">
            <img src={IMAGES.bike1} alt="Racing bike" className="auth-image" />
            <div className="auth-image-overlay">
              <h2 className="auth-image-title">JOIN THE RACE</h2>
              <p className="auth-image-text">Become part of the ultimate racing community today.</p>
            </div>
          </div>
          ...
          <div className="auth-form-side">
            <div className="auth-form-wrapper">
              ...
              <p className="auth-subtitle">Start your racing journey with Raceline</p>
              ...
              <form onSubmit={handleSubmit} className="auth-form">
                ...
                <label className="auth-remember auth-terms">
                  ...
                  />
                  <span>I agree to the <a href="#terms" className="auth-forgot">Terms of Service</a> and <a href="#privacy" className="auth-forgot">Privacy Policy</a></span>
                </label>
